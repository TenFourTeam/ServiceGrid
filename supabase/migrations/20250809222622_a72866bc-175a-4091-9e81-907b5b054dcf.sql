-- Unique numbering and helper functions + updated_at triggers

-- 1) Unique constraints for numbering per business
ALTER TABLE public.quotes
ADD CONSTRAINT IF NOT EXISTS unique_quote_number_per_business
UNIQUE (business_id, number);

ALTER TABLE public.invoices
ADD CONSTRAINT IF NOT EXISTS unique_invoice_number_per_business
UNIQUE (business_id, number);
