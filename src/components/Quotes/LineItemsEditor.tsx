...
export function LineItemsEditor({
  ...
  return <div className="space-y-3">
      ...
      {items.length === 0 ? <div className="text-center py-8 text-muted-foreground text-sm">No line items yet. Click "Add Item" to get started.</div> : <div className="border rounded-lg overflow-hidden">
